	...
	return []Tool{
		{
			...
			Description: "Return statically detected symbols declared in one source document using the lexical fallback engine.",
			InputSchema: codeSymbolSchema(true),
		},
		{
			Name:        "workspace_symbols",
			Title:       "Workspace Symbols",
			Description: "Search statically detected source declarations across the active workspace using the lexical fallback engine.",
			InputSchema: codeSymbolSchema(false),
		},
		{
			Name:        "find_definition",
			Title:       "Find Definition",
			Description: "Find likely source definitions for a symbol across supported source languages using static lexical parsing.",
			InputSchema: codeLookupSchema(),
		},
		{
			Name:        "find_references",
			Title:       "Find References",
			Description: "Find bounded whole-word source references to a symbol using static lexical parsing.",
			InputSchema: codeLookupSchema(),
		},
	}
}
